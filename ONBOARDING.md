...
| 7 | `HOW-TO.md` | 4K | Cookbook 40 use cases × 8 nhóm — daily lookup khi gặp task |
| 8 | `_shared/.agents/tier-0-executive/R-CoS-chief-of-staff.md` | 2K | Concierge agent — automation lễ tân, dùng từ Day 2+ |
